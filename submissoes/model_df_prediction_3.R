...
balanced_target <- ovun.sample(classe ~ ., data = data_select, method = "both",N = 650, seed = 1)$data
...
# gravando a saida
write.csv(df_predictions,file="submissoes/df_predictions_3.csv", row.names=FALSE)
